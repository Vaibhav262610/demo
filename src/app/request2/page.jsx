...
const page = () => {
  return (
    <div className='h-screen w-full flex flex-col gap-4 justify-center items-center '>
        ...
        <h3 className='text w-80 text-center'>and I also know that you were having mood swings that time but trust me Aditi i really never experience this before because I only approch those to whom i really cared for like you and that was the best time I had in my life</h3>
